...
monster.loot = {
	...
	{name = "red piece of cloth", chance = 1000},
	{name = "great mana potion", chance = 20000, maxCount = 3},
	{name = "terra boots", chance = 300},
	...
	{name = "springsprout rod", chance = 720},
	...
	{name = "cluster of solace", chance = 1000},
	{name = "dead weight", chance = 14180},
	{name = "Sai", chance = 1000},
	{name = "hemp rope", chance = 14180}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -500},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -250, maxDamage = -500, range = 5, radius = 3, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = true},
	 --poison
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = -25, maxDamage = -100, radius = 4, effect = CONST_ME_SLEEP, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -400, maxDamage = -500, range = 7, effect = CONST_ME_SLEEP, target = false}, 
	{name ="choking fear drown", interval = 2000, chance = 20, target = false},
	{name ="speed", interval = 2000, chance = 20, speedChange = -800, range = 5, effect = CONST_ME_MAGIC_RED, target = true, duration = 15000}
